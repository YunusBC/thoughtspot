  ...
  <div className="sidebar-container">
                <div className="sidemenu-container navbar-collapse collapse fixed-menu">
                   <div id="remove-scroll" className="left-sidemenu">
                       <ul className="sidemenu  page-header-fixed slimscroll-style paddingTop20" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200">
                           ...
                           <li className="sidebar-user-panel">
                               <div className="user-panel">
                                   <div className="pull-left image">
                                       <img src={require('../../assets/img/dp.jpg')} className="img-circle user-img-circle" alt="" />
                                   </div>
                           ...
                           <li className="nav-item">
                              <Link to="/searchbar" href="#" className="nav-link nav-toggle"><i className="material-icons">recent_actors</i>
